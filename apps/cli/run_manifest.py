...
class RunManifestGenerator:
    ...
    def load(
        self, manifest_path: str = "devbench_results/run_manifest.json"
...
def create_manifest(
    ...
    prompt_config: Dict[str, Any],
    evaluation_config: Dict[str, Any],
    output_dir: str = "devbench_results",
) -> str:
...
if __name__ == "__main__":
    ...
    test_config = {"version": "2.0.0", "generation": {"temperature": 0.2, "max_tokens": 1000}}

    test_prompt_config = {"total_count": 20, "generator": "auto"}

    test_eval_config = {"runs_per_prompt": 5, "parallel_execution": True}
