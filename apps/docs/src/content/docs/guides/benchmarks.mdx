---
title: Benchmarks
description: Model Lens benchmark methodology — scoring system, failure taxonomy, benchmark categories, and execution-grounded evaluation.
---
...
- [Architecture — Benchmark section](/architecture/#benchmark-architecture-dual-authority)
- [Prompt Packs](/guides/prompt-packs/) — how prompts are organized
