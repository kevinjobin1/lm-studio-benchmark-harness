...
- Read the [Architecture guide](/docs/architecture/) to understand how Model Lens works
- Check [Provider setup guides](/docs/guides/providers/) for provider-specific configuration
- Learn about [benchmark methodology](/docs/guides/benchmarks/) and scoring
