    ...
    datasets: [
      {
        ...
        borderColor: BAR_COLORS.slice(0, topModels.length).map(c => c.replace('0.7', '1')),
        borderWidth: 1,
        borderRadius: 6,
        borderSkipped: false,
      },
      {
        ...
        backgroundColor: BAR_COLORS.slice(0, topModels.length).map(c => c.replace('0.7', '0.25')),
        borderColor: BAR_COLORS.slice(0, topModels.length).map(c => c.replace('0.7', '0.5')),
        borderWidth: 1,
        borderRadius: 6,
        borderSkipped: false,
      },
