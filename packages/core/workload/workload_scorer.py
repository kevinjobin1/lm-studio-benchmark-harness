...
class WorkloadScorer:
    ...
    def _score_correctness(
        self, task: WorkloadTask, response: str, code_blocks: List[str]
    ) -> float:
    ...
    def _score_style_match(
        ...
        for block in code_blocks:
            ...
            if (context_camel > 5 and response_camel > 0) or (
                context_camel == 0 and response_camel == 0
            ):
                score += 0.15
