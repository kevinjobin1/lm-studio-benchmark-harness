...
Question: {q['question']}"""
            ...
            messages = [
                {"role": "system", "content": "You are a math problem solver. Show your work step by step, then output a line exactly like 'ANSWER: <number>' with the final numeric answer and nothing else after it."},
            ...
            try:
                ...
                if self.verbose:
                    ...
                    print(f"[VERBOSE gsm8k #{i+1}] Response ({len(response)} chars): {repr(response[:200])}")
                ...
                if self.verbose and predicted is not None:
                    ...
                    print(f"[VERBOSE gsm8k #{i+1}] Extracted: {predicted} | Expected: {q['answer']} -> {status}")
                elif self.verbose:
                    print(f"[VERBOSE gsm8k #{i+1}] Extracted: None (no number found) | Expected: {q['answer']} -> INCORRECT")
...
Question: {q['question']}"""
            ...
            messages = [
                {"role": "system", "content": "You are a math problem solver. Show your work step by step, then output a line exactly like 'ANSWER: <integer>' with the final numeric answer and nothing else after it."},
                {"role": "user", "content": prompt}
            ]
            ...
            try:
                ...
                if self.verbose:
                    ...
                    print(f"[VERBOSE aime #{i+1}] Response ({len(response)} chars): {repr(response[:200])}")
                ...
                if self.verbose and predicted is not None:
                    ...
                    print(f"[VERBOSE aime #{i+1}] Extracted: {predicted} | Expected: {q['answer']} -> {status}")
                elif self.verbose:
                    print(f"[VERBOSE aime #{i+1}] Extracted: None (no number found) | Expected: {q['answer']} -> INCORRECT")
