...
Question: What is the special code mentioned in the text? Respond with ONLY the code, no other text."""
            ...
            messages = [
                {
                    "role": "system",
                    "content": "You are a text retrieval system. Respond with ONLY the exact code or answer requested — no explanations, no punctuation, no surrounding text.",
                },
            ...
            try:
                ...
                if self.verbose:
                    ...
                    print(
                        f"[VERBOSE needle #{context_length}] Response ({len(response)} chars): {repr(response)}"
                    )
