"""
Jan provider adapter — local LLM provider via OpenAI-compatible API.
...
DEFAULT_JAN_URL = "http://localhost:1337"
DEFAULT_JAN_V1_URL = "http://localhost:1337/v1"


class JanClient(ProviderAdapter):
    """
    Jan provider adapter using the OpenAI-compatible API.
    Jan exposes /v1/chat/completions matching the OpenAI spec.
    """
    ...
    def list_models(self) -> List[Model]:
        """List all models available in Jan."""
        models: List[Model] = []
        try:
            ...
            print(f"[jan] Error listing models: {e}")
        return models
    ...
    def chat_completion(
        ...
        """Chat completion via Jan's OpenAI-compatible API."""
