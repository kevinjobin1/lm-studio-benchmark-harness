...
> This file is the single source of truth for Codebuff when operating on this codebase.
...
| File | Purpose |
|------|---------|
| `ARCHITECTURE.md` | System design — package responsibilities, data flow, event architecture |
| `VISION.md` | Philosophy — why this project exists, what we won't build |
| `ROADMAP.md` | Future evolution — what's planned, what's complete |
| `README.md` | User-facing overview |
| `knowledge.md` | Operational truth for Codebuff — codenames, paths, gotchas |
| `CHANGELOG.md` | Release history |
| `docs/specs/run-schema.md` | Canonical data model |
| `docs/specs/event-schema.md` | Event bus contract |
| `docs/specs/provider-contract.md` | Provider adapter contract |
